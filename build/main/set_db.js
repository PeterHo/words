...
db.files = new Datastore({
    filename: path.resolve(_constants2.default.DB_PATH, './files'),
    autoload: true,
    timestampData: true
});

db.books = new Datastore({
    filename: path.resolve(_constants2.default.DB_PATH, './books'),
    autoload: true,
    timestampData: true
});

db.tags = new Datastore({
    filename: path.resolve(_constants2.default.DB_PATH, './tags'),
    autoload: true,
    timestampData: true
});

db.infos = new Datastore({
    filename: path.resolve(_constants2.default.DB_PATH, './infos'),
    autoload: true,
    timestampData: true
});
